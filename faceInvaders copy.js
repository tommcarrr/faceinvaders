    ...
    for (var i = enemies.length - 1; i >= 0; i--) {
        ...
        for (var j = bullets.length - 1; j >= 0; j--) {
            ...
            if (bullet.x < enemy.x + enemy.width &&
                ...
                MAX_ENEMY_SPAWN_DELAY = Math.min(MAX_ENEMY_SPAWN_DELAY + MAX_ENEMY_SPAWN_INCREMENT, MIN_ENEMY_SPAWN_DELAY);
                break;
            }
        }
    }
...
function spawnPowerUp() {
    var powerUp = {
        ...
        dx: 0,
        dy: canvas.width * ENEMY_SPEED_MODIFIER + score / 50,
    };
    powerUps.push(powerUp);

    var nextSpawnDelay = 10000;
    setTimeout(spawnEnemy, nextSpawnDelay);
}
